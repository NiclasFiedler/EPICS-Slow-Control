...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_dev_ai_SAA,
    *pvar_dset_dev_ai_lm75, *pvar_dset_dev_ai_sht21,
    *pvar_dset_dev_ai_ads1115, *pvar_dset_dev_ai_dac,
    *pvar_dset_dev_ai_eeprom, *pvar_dset_dev_ai_pca9554,
    *pvar_dset_dev_ai_apfel, *pvar_dset_devAoSoft,
    *pvar_dset_devAoSoftRaw, *pvar_dset_devAoSoftCallback,
    *pvar_dset_dev_ao_dac, *pvar_dset_dev_ao_eeprom_set,
    *pvar_dset_dev_ao_eeprom_reg, *pvar_dset_dev_ao_pca9554,
    *pvar_dset_dev_ao_apfel, *pvar_dset_devBiSoft,
    ...
    *pvar_dset_dev_bo_apfel, *pvar_dset_devCalcoutSoft,
    ...
    *pvar_dset_devIocVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "dev_ai_SAA", "dev_ai_lm75", "dev_ai_sht21", "dev_ai_ads1115",
    "dev_ai_dac", "dev_ai_eeprom", "dev_ai_pca9554", "dev_ai_apfel",
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "dev_ao_dac",
    "dev_ao_eeprom_set", "dev_ao_eeprom_reg", "dev_ao_pca9554",
    "dev_ao_apfel", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "devBoSoft", "devBoSoftRaw", "devBoSoftCallback",
    "devBoGeneralTime", "devBoDbState", "dev_bo_apfel", "devCalcoutSoft",
    ...
    "devLsiEnviron", "devIocVersion", "devLsoSoft", "devLsoSoftCallback",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_dev_ai_SAA, pvar_dset_dev_ai_lm75, pvar_dset_dev_ai_sht21,
    pvar_dset_dev_ai_ads1115, pvar_dset_dev_ai_dac,
    pvar_dset_dev_ai_eeprom, pvar_dset_dev_ai_pca9554,
    pvar_dset_dev_ai_apfel, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_dev_ao_dac,
    pvar_dset_dev_ao_eeprom_set, pvar_dset_dev_ao_eeprom_reg,
    pvar_dset_dev_ao_pca9554, pvar_dset_dev_ao_apfel, pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw, pvar_dset_devBiSoftCallback,
    pvar_dset_devBiDbState, pvar_dset_devBoSoft, pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback, pvar_dset_devBoGeneralTime,
    pvar_dset_devBoDbState, pvar_dset_dev_bo_apfel,
    ...
    pvar_dset_devLsiEnviron, pvar_dset_devIocVersion,
...
int Ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/lab160/EPICS/ioc";
...
static const iocshFuncDef rrddFuncDef =
    {"Ioc_registerRecordDeviceDriver", 1, rrddArgs};
